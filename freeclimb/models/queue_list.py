...
class QueueList(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    QueueList
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["total", "start", "end", "page", "numPages", "pageSize", "nextPageUri", "queues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queues": [QueueResult.from_dict(_item) for _item in obj["queues"]] if obj.get("queues") is not None else None
        })
        return _obj
