...
class QueueMemberList(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    QueueMemberList
    """ # noqa: E501
    ...
    queue_members: Optional[List[QueueMember]] = Field(default=None, alias="queueMembers")

    __properties: ClassVar[List[str]] = ["total", "start", "end", "page", "numPages", "pageSize", "nextPageUri", "queueMembers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queueMembers": [QueueMember.from_dict(_item) for _item in obj["queueMembers"]] if obj.get("queueMembers") is not None else None
        })
        return _obj
