...
class CallList(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    CallList
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["total", "start", "end", "page", "numPages", "pageSize", "nextPageUri", "calls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "calls": [CallResult.from_dict(_item) for _item in obj["calls"]] if obj.get("calls") is not None else None
        })
        return _obj
