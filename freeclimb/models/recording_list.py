...
class RecordingList(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    RecordingList
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["total", "start", "end", "page", "numPages", "pageSize", "nextPageUri", "recordings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recordings": [RecordingResult.from_dict(_item) for _item in obj["recordings"]] if obj.get("recordings") is not None else None
        })
        return _obj
