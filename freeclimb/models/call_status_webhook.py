...
class CallStatusWebhook(Webhook, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    ...
    """ # noqa: E501
    request_type: Optional[StrictStr] = Field(default=None, description="Context or reason why this request is being made. Will be callStatus - A Call has ended and the statusCallbackUrl is being invoked.", alias="requestType")
    ...
    call_ended_reason: Optional[CallEndedReason] = Field(default=None, alias="callEndedReason")
    ...
    __properties: ClassVar[List[str]] = ["requestType", "callId", "accountId", "from", "to", "callStatus", "callEndedReason", "direction", "conferenceId", "queueId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.call_ended_reason is None and "call_ended_reason" in self.model_fields_set:
