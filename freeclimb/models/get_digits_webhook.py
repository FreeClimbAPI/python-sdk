...
class GetDigitsWebhook(Webhook, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    A POST request with the following fields will be sent to the actionUrl provided in your GetDigits command.
    """ # noqa: E501
    request_type: Optional[StrictStr] = Field(default=None, description="Context or reason why this request is being made. Will be getDigits - The GetDigits command has completed and its actionUrl is being invoked.", alias="requestType")
    ...
    digits: Optional[StrictStr] = Field(default=None, description="tring of digits entered by the Caller, excluding the terminating digit (if used). The string of digits will be replaced by 'xxxxx' when privacyMode is set to true")
