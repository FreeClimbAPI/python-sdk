...
class OutDialStartWebhook(Webhook, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    ...
    """ # noqa: E501
    request_type: Optional[StrictStr] = Field(default=None, description="Context or reason why this request is being made. Will be outDialStart - The OutDial command has started and the actionUrl is being invoked.", alias="requestType")
    ...
    dial_call_id: Optional[StrictStr] = Field(default=None, description="ID of the child call that was generated as a result of the Outdial.", alias="dialCallId")
    parent_call_id: Optional[StrictStr] = Field(default=None, description="ID of the Call that created this leg (child call). If this was an inbound call or call created via REST API with no parent, this field will be null.", alias="parentCallId")

    __properties: ClassVar[List[str]] = ["requestType", "accountId", "callId", "from", "to", "callStatus", "direction", "conferenceId", "queueId", "dialCallId", "parentCallId"]
