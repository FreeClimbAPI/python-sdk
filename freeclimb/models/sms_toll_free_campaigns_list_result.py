...
class SMSTollFreeCampaignsListResult(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    ...
    __properties: ClassVar[List[str]] = ["total", "start", "end", "page", "numPages", "pageSize", "nextPageUri", "brands"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "brands": [SMSTollFreeCampaign.from_dict(_item) for _item in obj["brands"]] if obj.get("brands") is not None else None
        })
        return _obj
