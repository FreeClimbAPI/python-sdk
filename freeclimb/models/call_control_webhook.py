...
class CallControlWebhook(Webhook, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    ...
    """ # noqa: E501
    request_type: Optional[StrictStr] = Field(default=None, description="Context or reason why this request is being made. Will be callControl.", alias="requestType")
    ...
    digits: Optional[StrictStr] = Field(default=None, description="String of digits entered by the participant.")
