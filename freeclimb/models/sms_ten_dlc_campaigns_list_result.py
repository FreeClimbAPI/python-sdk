...
class SMSTenDLCCampaignsListResult(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    ...
    __properties: ClassVar[List[str]] = ["total", "start", "end", "page", "numPages", "pageSize", "nextPageUri", "campaigns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "campaigns": [SMSTenDLCCampaign.from_dict(_item) for _item in obj["campaigns"]] if obj.get("campaigns") is not None else None
        })
        return _obj
