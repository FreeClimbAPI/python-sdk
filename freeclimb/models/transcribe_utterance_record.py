...
class TranscribeUtteranceRecord(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "saveRecording": obj.get("saveRecording") if obj.get("saveRecording") is not None else False,
            "maxLengthSec": obj.get("maxLengthSec") if obj.get("maxLengthSec") is not None else 60,
