...
class RecordingResult(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    RecordingResult
    """ # noqa: E501
    ...
    recording_id: Optional[StrictStr] = Field(default=None, description="String that uniquely identifies this recording resource.", alias="recordingId")
    account_id: Optional[StrictStr] = Field(default=None, description="ID of the account that created this recording.", alias="accountId")
    call_id: Optional[StrictStr] = Field(default=None, description="ID of the Call that was recorded. If a Conference was recorded, this value is empty and the conferenceId property is populated.", alias="callId")
    duration_sec: Optional[StrictInt] = Field(default=None, description="Length of the recording in seconds.", alias="durationSec")
    conference_id: Optional[StrictStr] = Field(default=None, description="ID of the Conference that was recorded. If a Call was recorded, this value is empty and the callId property is populated.", alias="conferenceId")

    __properties: ClassVar[List[str]] = ["uri", "dateCreated", "dateUpdated", "revision", "recordingId", "accountId", "callId", "durationSec", "conferenceId"]
