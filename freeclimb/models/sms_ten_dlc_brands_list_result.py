...
class SMSTenDLCBrandsListResult(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "brands": [SMSTenDLCBrand.from_dict(_item) for _item in obj["brands"]] if obj.get("brands") is not None else None
        })
        return _obj
