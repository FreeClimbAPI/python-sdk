...
class IncomingNumberList(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    IncomingNumberList
    """ # noqa: E501
    ...
    incoming_phone_numbers: Optional[List[IncomingNumberResult]] = Field(default=None, alias="incomingPhoneNumbers")

    __properties: ClassVar[List[str]] = ["total", "start", "end", "page", "numPages", "pageSize", "nextPageUri", "incomingPhoneNumbers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.incoming_phone_numbers is None and "incoming_phone_numbers" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "incomingPhoneNumbers": [IncomingNumberResult.from_dict(_item) for _item in obj["incomingPhoneNumbers"]] if obj.get("incomingPhoneNumbers") is not None else None
        })
        return _obj
