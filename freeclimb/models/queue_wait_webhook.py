...
class QueueWaitWebhook(Webhook, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    ...
    """ # noqa: E501
    request_type: Optional[StrictStr] = Field(default=None, description="Context or reason why this request is being made. Will be queueWait - A queued call is requesting instructions to execute during the wait in the queue and the corresponding waitUrl is being invoked.", alias="requestType")
    ...
    queue_position: Optional[StrictStr] = Field(default=None, description="Current queue position of the enqueued Call.", alias="queuePosition")
    ...
    current_queue_size: Optional[StrictInt] = Field(default=None, description="Current number of enqueued Calls in this Queue.", alias="currentQueueSize")

    __properties: ClassVar[List[str]] = ["requestType", "accountId", "callId", "from", "to", "callStatus", "direction", "conferenceId", "queueId", "queuePosition", "queueTime", "currentQueueSize"]
