...
class GetSpeechWebhook(Webhook, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    ...
    """ # noqa: E501
    request_type: Optional[StrictStr] = Field(default=None, description="Context or reason why this request is being made. Will be getSpeech - The GetSpeech command has completed and its actionUrl is being invoked.", alias="requestType")
    ...
    recognition_result: Optional[StrictStr] = Field(default=None, description="Semantic content (either a string if speech was recognized or a digit if a digit was input instead of speech) returned from the entry or tag that was recognized within the grammar. The content will be replaced by 'xxxxx' when privacyMode is set to true. This field is populated only if the reason field is set to recognition or digit.", alias="recognitionResult")
    confidence: Optional[StrictInt] = Field(default=None, description="Level of confidence in the obtained result. This is a value in the range 0 to 100 – with 0 being total lack of confidence and 100 being absolute certainty in the recognition. This field is populated only if the reason field is set to recognition.")
    ...
    completion_reason: Optional[StrictStr] = Field(default=None, description="Advanced diagnostic information if reason was error. See RFC 6787 section 9.4.12 - speech recognition.", alias="completionReason")
    completion_cause: Optional[StrictStr] = Field(default=None, description="Advanced diagnostic information if reason was error. See RFC 6787 section 9.4.11 - speech recognition.", alias="completionCause")
    mrcp_code: Optional[StrictInt] = Field(default=None, description="Advanced diagnostic information if reason was error. See RFC 6787 section 5.4 - MRCPv2 specification.", alias="mrcpCode")
    mrcp_diagnostic: Optional[StrictStr] = Field(default=None, description="Advanced diagnostic information if reason was error. See RFC 6787 section 5.4 - MRCPv2 specification.", alias="mrcpDiagnostic")
