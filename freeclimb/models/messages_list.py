...
class MessagesList(BaseModel, populate_by_name=True, validate_assignment=True, protected_namespaces=()):
    """
    MessagesList
    """ # noqa: E501
    ...
    messages: Optional[List[MessageResult]] = Field(default=None, description="Array of messages")

    __properties: ClassVar[List[str]] = ["total", "start", "end", "page", "numPages", "pageSize", "nextPageUri", "messages"]
