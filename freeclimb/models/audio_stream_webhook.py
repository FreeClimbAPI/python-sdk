...
class AudioStreamWebhook(
    ...
    request_type: Optional[StrictStr] = Field(
        default=None,
        description="Context or reason why this request is being made. Will be audioStream - gRPC session for this Call has ended and its actionUrl is being invoked.",
        alias="requestType",
    )
    call_id: Optional[StrictStr] = Field(
        default=None,
        description="Unique ID for this Call, generated by FreeClimb. This is the call leg which ended its gRPC session.",
        alias="callId",
    )
