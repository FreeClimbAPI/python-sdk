...
class TranscribeUtterance(PerclCommand):
    ...
    record: Optional[TranscribeUtteranceAllOfRecord] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "playBeep": obj.get("playBeep") if obj.get("playBeep") is not None else False,
            "record": TranscribeUtteranceAllOfRecord.from_dict(obj["record"]) if obj.get("record") is not None else None,
