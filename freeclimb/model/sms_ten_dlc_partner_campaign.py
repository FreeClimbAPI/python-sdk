...
def lazy_import():
    from freeclimb.model.sms_ten_dlc_partner_campaign_brand import (
...
class SMSTenDLCPartnerCampaign(ModelNormal):
    ...
    def _from_openapi_data(
        cls, campaign_id, brand_id, usecase, description, *args, **kwargs
    ):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, campaign_id, brand_id, usecase, description, *args, **kwargs
    ):  # noqa: E501
        """SMSTenDLCPartnerCampaign - a model defined in OpenAPI
