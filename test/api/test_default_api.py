...
class TestDefaultApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.api = freeclimb.ApiClient(configuration)
    ...
    def test_download_a_recording_file(self) -> None:
        ...
        assert isinstance(api_response, bytearray)
    ...
    def test_list_calls(self) -> None:
        ...
        api_response = self.api.list_calls(active=active,to=to,var_from=var_from,status=status,start_time=start_time,end_time=end_time,parent_call_id=parent_call_id,application_id=application_id)
    ...
    def test_list_sms_messages(self) -> None:
        ...
        api_response = self.api.list_sms_messages(to=to,var_from=var_from,begin_time=begin_time,end_time=end_time,direction=direction,campaign_id=campaign_id,brand_id=brand_id,is10_dlc=is10_dlc)
...
create_web_rtc_token_make_a_webrtc_jwt_test_value = CreateWebRTCToken(to="to_example", var_from="from_example", uses=1)
