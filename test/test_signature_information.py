...
class TestSignatureInformation(unittest.TestCase):
    ...
    global time_stamp
    def setUp(self):
        request_header = "t=" + str(time_stamp) + ",v1=c3957749baf61df4b1506802579cc69a74c77a1ae21447b930e5a704f9ec4120,v1=1ba18712726898fbbe48cd862dd096a709f7ad761a5bab14bda9ac24d963a6a8"
    ...
    def test_is_request_time_valid_false(self):
        tolerance = sys.maxsize - time_stamp
