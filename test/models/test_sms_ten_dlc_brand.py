...
class TestSMSTenDLCBrand(unittest.TestCase):
    ...
    def test_brand_relationship(self):
        ...
        assert self.model.brand_relationship == SMSTenDLCBrandRelationship.MEDIUM_ACCOUNT
    ...
    def test_identity_status(self):
        ...
        assert self.model.identity_status == SMSTenDLCBrandIdentityStatus.VETTED_VERIFIED
