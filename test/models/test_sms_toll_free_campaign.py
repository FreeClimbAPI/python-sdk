...
class TestSMSTollFreeCampaign(unittest.TestCase):
    ...
    def test_registration_status(self):
        ...
        self.model.registration_status = SMSTollFreeCampaignRegistrationStatus.UNREGISTERED
        assert self.model.registration_status == SMSTollFreeCampaignRegistrationStatus.UNREGISTERED
        self.model.registration_status = SMSTollFreeCampaignRegistrationStatus.INITIATED
        assert self.model.registration_status == SMSTollFreeCampaignRegistrationStatus.INITIATED
        self.model.registration_status = SMSTollFreeCampaignRegistrationStatus.PENDING
        assert self.model.registration_status == SMSTollFreeCampaignRegistrationStatus.PENDING
        self.model.registration_status = SMSTollFreeCampaignRegistrationStatus.DECLINED
        assert self.model.registration_status == SMSTollFreeCampaignRegistrationStatus.DECLINED
        self.model.registration_status = SMSTollFreeCampaignRegistrationStatus.REGISTERED
