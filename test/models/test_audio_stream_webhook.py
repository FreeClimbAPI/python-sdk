...
class TestAudioStreamWebhook(unittest.TestCase):
    """AudioStreamWebhook unit test stubs"""

    def setUp(self):
        self.model = AudioStreamWebhook()

    def test_request_type(self):
        """Test AudioStreamWebhook.request_type"""

    def test_call_id(self):
        """Test AudioStreamWebhook.call_id"""

        self.model.call_id = "TEST_STRING"
        assert self.model.call_id == "TEST_STRING"

    def test_account_id(self):
        """Test AudioStreamWebhook.account_id"""

        self.model.account_id = "TEST_STRING"
        assert self.model.account_id == "TEST_STRING"

    def test_var_from(self):
        """Test AudioStreamWebhook.var_from"""

        self.model.var_from = "TEST_STRING"
        assert self.model.var_from == "TEST_STRING"

    def test_to(self):
        """Test AudioStreamWebhook.to"""

        self.model.to = "TEST_STRING"
        assert self.model.to == "TEST_STRING"

    def test_call_status(self):
        """Test AudioStreamWebhook.call_status"""
    ...
    def test_direction(self):
        """Test AudioStreamWebhook.direction"""
    ...
    def test_deserialize(self):
        ...
        assert isinstance(AudioStreamWebhook.deserialize(payload), AudioStreamWebhook)
